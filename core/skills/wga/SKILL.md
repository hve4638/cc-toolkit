---
name: wga
description: "[writing-great-agents-md] Reference for writing and editing context files (CLAUDE.md, AGENTS.md) — what earns a place in an always-loaded file. Pass file paths to review them against it."
