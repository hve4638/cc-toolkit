...
// Flags CLAUDE.md / AGENTS.md edits to a session flag file; the Stop hook
...
const TARGETS = new Set(['CLAUDE.md', 'AGENTS.md']);
const HINT_COMMAND = '/writing-great-agents-md';
