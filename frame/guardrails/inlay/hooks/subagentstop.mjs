...
export default async function subagentstop(payload) {
  if (payload.hook_event_name && payload.hook_event_name !== 'SubagentStop') return null;
  ...
  return { block: buildAlert(stale, agent_id) };
}
