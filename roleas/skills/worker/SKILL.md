...
- 단순 버그 수정, 명확한 작업 완료 시 -> 바로 merge&land로 진입
- 기능 추가, 복잡한 버그 수정 등 사용자가 직접 판단할 요소가 있는 경우. -> 사용자가 확인할 수 있도록 준비하고 대기

## Orchestrator와 상호작용

- 작업 종료(merge 시), 또는 필요한 맥락 추가 제공 필요 시, 또는 범위 외 문제 보고 시 SendMessage를 통해 Orchestrator와 통신해라.
