---
name: rule-of-workspace
description: "워크스페이스 규칙"
---
...
│  ├─ milestone/   # 목표 단위 — todo 묶음 (RULE_OF_MILESTONE.md)
│  └─ todo/        # 작업 관리 (RULE_OF_TODO.md)
...
- [RULE_OF_TODO.md](RULE_OF_TODO.md): todo 작업 수행 시
- [RULE_OF_MILESTONE.md](RULE_OF_MILESTONE.md): milestone 작업 수행 시
</rule-of-workspace>
